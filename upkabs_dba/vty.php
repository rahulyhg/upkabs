<?php
	...
	: Mail      : vtydev@gmail.com                                             :
	: Developer : zall (zall@uludagsozluk.com)                                 :
	:                                                                          :
	:                                                                          :
	:...........................................................................
	...
	: http://www.kutukutu.com/vty/license.txt                                  :
	:                                                                          :
	:                                                                          :
	:...........................................................................
	...
	function dil(){
		if($this->dl=='tr'){
			...
			*/
			...
			$dil['Gonder']           = 'Gönder';                    //"Send"
			$dil['Reset']            = 'Temizle';                   //"Reset"
			$dil['Tamam']            = 'Tamam';                     //"OK"
			$dil['Uygula']           = 'Uygula';                    //"Apply"
			$dil['Iptal']            = 'Ýptal';                     //"Cancel"
			$dil['Yukari']           = 'Yukarý';                    //"Up Level"
			$dil['Satir']            = 'Satýr';                     //"Line"
			$dil['Hata']             = 'Hata';                      //"Error"
			$dil['HataAcklm']        = 'Hata açýklamasý';           //"Error desciription"
			$dil['MysqlHata']        = 'Mysql Hatasý';           //"Error desciription"
			$dil['Cevap']            = 'Cevap';                     //"Answer"
			$dil['Evet']             = 'Evet';                      //"Yes"
			$dil['Hayir']            = 'Hayýr';                     //"No"
			$dil['Ekle']             = 'Ekle';                      //"Add"
			$dil['Olustur']          = 'Oluþtur';                   //"Create"
			$dil['Devam']            = 'Devam';                     //"Next"
			$dil['Geri']             = 'Geri';                      //"Back"
			$dil['Seciniz']          = 'Seçiniz';                   //"Choose"
			$dil['YeniTbAdi']        = 'Yeni tablo adý';            //"New table name"
			...
			$dil['Gelistir']         = 'Geliþtir';                  //"Develop"
			$dil['Ayarlar']          = 'Ayarlar';                   //"Options"
			$dil['Yardim']           = 'Yardým';                    //"Help"
			$dil['VtYonet']          = 'MySQL için '.
                                       'veritabaný yöneticisi';     //"Database manager for MySQL"
			$dil['Vt']               = 'Veritabaný';                //"Database"
			$dil['Dosyadan']         = 'Dosyadan';                  //"From File"
			$dil['Tablo']            = 'Tablo';                     //"Table"
			$dil['VtSeciniz']        = 'Baþlamak için bir '.
                                       'veritabaný seçiniz';        //"Choose a Database to Start"
			$dil['TbSeciniz']        = 'Tablo seçiniz';             //"Choose a Table"
			$dil['SayfaYnl']         = 'Sayfayý Yenile';            //"Refresh"
			...
			$dil['Kisalt']           = '&gt; Kýsalt &lt;';          //"&gt; Shorter &lt;"
			$dil['Hep']              = 'Hep';                       //"All"
			$dil['Hic']              = 'Hiç';                       //"None"
			$dil['EnAlt']            = 'En Alt';                    //"Bottom"
			$dil['EnUst']            = 'En Üst';                    //"Top"
			$dil['VtAdi']            = 'VeritabanýAdý';             //"DatabaseName"
			$dil['TbAdi']            = 'TabloAdý';                  //"TableName"
			$dil['SutunSys']         = 'Sütun Sayýsý';              //"Field Number"
			$dil['TbBosalt']         = 'Bu tabloyu boþalt';         //"EMPTY this TABLE"
			$dil['TbKaldir']         = 'Bu tabloyu kaldýr';         //"DROP this TABLE"
			$dil['DumpTables']       = 'Döküm Oluþtur';             //"DUMP"
			$dil['SatirEkle']        = 'Yeni Satýr Ekle';           //"Add New Row"
			$dil['SatirDzlt']        = 'Satýrlarý Düzelt';          //"Edit Rows"
			$dil['DbHost']           = 'Host';                      //"Host Name"
			$dil['DbKullAdi']        = 'Kullanýcý Adý';             //"User Name"
			$dil['DbSifre']          = 'Þifre';                     //"Password"
			$dil['SessCikis']        = 'Çýkýþ';                     //"Session Log Out"
			$dil['db_type']          = 'Veritabaný';                //"Server Type"
			$dil['GrsHts']           = 'Baðlantý Hatasý';           //"Connection Error"
			$dil['sayfalar']         = 'Sayfalar';                  //"Pages"
			$dil['sayfa']            = 'Sayfa';                     //"Page"
			$dil['SayfaBasi']        = 'Sayfa Baþý';                //"Rows per page"
			$dil['Yeni']             = 'Yeni';                      //"New"
			$dil['AnaMenu']          = 'Ana Sayfa';                 //"Main Menu"
			$dil['WellComeToVty']    = "VTY'ye Hoþ Geldiniz";       //"Wellcome to Vty"
			$dil['About']            = "Hakkýnda";        			//"about"
			...
			$dil['DumpSubmit']       = "Þimdi Dump Et";           			//"Dump Now"

			$uy['EminmisinCikis']    = "Oturumunuzu kapatýp çýkmak istediðinizden emin misiniz?\\n";
			$uy['EminmisinSil']      = "Seçtiðiniz satýrý silmek istediðinizden emin misiniz?\\n";
			$uy['EminmisinBosalt']   = "Seçtiðiniz satýrý boþaltmak istediðinizden emin misiniz?";
			$uy['EminmisinKaldir']   = "Seçtiðiniz satýrý kaldýrmak istediðinizden emin misiniz?";
			$uy['EminmisinDbSil']    = 'Emin misiniz?\\nSeçtiðiniz veritabanýný kaldýrmak istiyor musunuz?';
			$uy['KomutCalistirildi'] = 'Sorgu çalýþtýrýldý';
			$uy['KacSatirEtkilendi'] = 'satýr etkilendi';
			$uy['loginBilgi']        = 'Database serverina baðlanmak için kullanýcý adýnýzý ve þifresinizi giriniz. (Cookie abanlý.)';
			$uy['destekYok']         = 'Php ayarlarýnýz @DbType@ ile ilgili fonksiyonlarý desteklememektedir.';
			$uy['YeniDbOldu']        = '`@NewDbName@` veritabaný oluþturuldu.';
			$uy['YeniDbHata']        = 'Yeni `@NewDbName@` veritabaný oluþturulurken hata oldu.';
			$uy['YeniTbOldu']        = '`@NewTbName@` tablosu oluþturuldu.';
			$uy['YeniTbHata']        = 'Yeni `@NewTbName@` tablosu oluþturulurken hata oldu.';
			$uy['DbSilEminmi']       = 'Emin misiniz? `@DbName@` veritabanýný kaldýrmak istiyor musunuz?';
			$uy['DbSilHata']         = '`@DbName@` veritabanýný kaldýrýlýrken hata oluþtu.';
			$uy['DbSilOldu']         = '`@DbName@` veritabaný kaldýrýldý.';
			$uy['YeniSatirOldu']     = 'Yeni satýr eklendi.';
			$uy['YeniSatirHata']     = 'Yeni satýr eklerken hata oluþtu.';
			$uy['SatirlarDuzeldi']   = 'Seçtiðiniz satýrlar düzeltildi.';
			$uy['SatirlarDuzeltHata']= 'Seçtiðiniz satýrlar düzeltilirken hata oluþtu.';
			$uy['SatirDuzeldi']      = 'Seçtiðiniz satýr düzeltildi.';
			$uy['SatirDuzelHata']    = 'Seçtiðiniz satýr düzeltilirken hata oluþtu.';
			$uy['SatirSilindi']      = 'Seçtiðiniz satýr silindi.';
			$uy['SatirSilHata']      = 'Seçtiðiniz satýr silinirken hata oluþtu.';
			$uy['SatirNSilindi']     = 'Seçtiðiniz @number@ satýr silindi.';
			$uy['SatirSilNHata']     = 'Seçtiðiniz satýrlardan @number@ tanesi silinirken hata olustu.';
			$uy['OturumKapa']        = 'Oturum kapatýldý.';
			$uy['OturumKaHata']      = 'Oturum kapatýlýrken hata oluþtu.';
			$uy['ToplamSatir']       = 'Satýr Sayýsý: @number@';
			$uy['SatirYok']          = 'Tabloda hiç satýr yok.';
			$uy['BosaltEmin']        = '@DbTable@ tablosunu boþaltmak istediðinizden istiyor musunuz?';
			$uy['BosaltOldu']        = '@DbTable@ tablosu boþaltýldý.';
			$uy['BosaltHata']        = '@DbTable@ tablosu boþaltýlýrken hata oluþtu.';
			$uy['KaldirEmin']        = '@DbTable@ tablosunu kaldýrmak istediðinizden emin misiniz?';
			$uy['KaldirOldu']        = '@DbTable@ tablosu kaldýrýldý.';
			$uy['KaldirHata']        = '@DbTable@ tablosu kaldýrýlýrken hata oluþtu.';
			$uy['YeniDilSec']        = 'Select your new language';
			$uy['CookieError']       = 'Tarayýcýnýz çerezleri (cookie) kabul etmemektedir. Lütfen tarayýcýnýz ayarlarýný deðiþtiriniz.';
			$uy['CookieErrorBas']    = 'Cookie Hatasý';
			...
			*/		
			...
			$dil['HataAcklm']        = 'Error en Descripción';       //"Error desciription"
			...
			$dil['Sorgu']            = 'Interrogación';              //"Query"
			$dil['Sql']              = 'Interrogación SQL';          //"Sql Query"
			...
			$dil['SatirEkle']        = 'Añadir Nueva Fila';          //"Add New Row"
			$dil['SatirDzlt']        = 'Editar Fila';                //"Edit Rows"
			$dil['DbHost']           = 'Nombre del Host';            //"Host Name"
			$dil['DbKullAdi']        = 'Nombre del Usuario';         //"User Name"
			$dil['DbSifre']          = 'Contraseña';                 //"Password"
			$dil['SessCikis']        = 'Desconectar';                //"Session Log Out"
			$dil['db_type']          = 'Tipo de Servidor';           //"Server Type"
			$dil['GrsHts']           = 'Error de Conexión';          //"Connection Error"
			$dil['sayfalar']         = 'Páginas';                    //"Pages"
			$dil['sayfa']            = 'Página';                     //"Pages"
			$dil['SayfaBasi']        = 'Filas por página';           //"Rows per page"
			$dil['Yeni']             = 'Nuevo';                      //"New"
			...
			$uy['KomutCalistirildi'] = 'Interrogación OK';
			$uy['KacSatirEtkilendi'] = 'filas seleccionadas';
			$uy['loginBilgi']        = 'Por favor Teclee su Nombre y Contraseña para conectar. (Basado en Cookies)';
			$uy['destekYok']         = 'La configuración PHP no soporta funciones @DbType@.';
			...
			$uy['YeniSatirOldu']     = 'Nuevo Registro Añadido.';
			$uy['YeniSatirHata']     = 'Ha ocurrido un error al Añadir un Registro.';
			...
			$uy['OturumKapa']        = 'Sesión cerrada';
			$uy['OturumKaHata']      = 'Ha ocurrido un error al cerrar la sesión.';
...
<br />
  ...
  Enis Çoban, eniscoban@gmail.com<br>
...
class vty
{
	...
	* baglan()
	*
	* Baglantiyi Yapan fonksiyon, baglanti yapilip yapilmadigina göre sonuc döner,
	...
	* SayfaYap()
	*
	* Çekilen verileri (mesela) 50'ser 50'ser sayfalara ayiran fonksiyon
	*
	...
	* urlyap()
	*
	* Çok sik kullanilan bir fonksiyon, linkler olusturur. 
	* 
	* @param $url dl=tr&sdb=test&stb=table sekinde bilgiler icerir
	* @param $root kök varmi? yok mu?
	...
	* PrimaryVarMi()
	*
	* Bir tabloda Primary varmi yokmu onu söyler
	*/
    ...
    * DiziyiAc()
    *
    * Bir Dizideki deðiþken deðerlerini aralarýna $ara koyarak sýralar.
    *
    */
...
class islemler
{
	...
	* sesscikis
	*
	* Çikis tusuna basinca sessini kapatan fonksiyon
	*
	*/
	function sesscikis()
	{
	...
	* SqlGoster
	*
	* SQL Çalistirma ve sonuç gösterme ana formu, ana sayfasi
	*
	*/
	function SqlGoster()
	{
    ...
    * DumpEtJS
    *
    * Dump et sayfasýndaki javascriptler
    */
    function DumpEtJs(){
	...
	*/
	function YeniTableEkliyorum(){
		...
		if(!empty($fieldsayisi)){
                ...
                if($k==0) $this->vty->HataGoster2("<br>Gönderdiniz form bos.");
        }//i
	}
...
class sectim
{
	...
	*/
	...
	// sdscheck: formdaki herbir satýrý ifade eden id niteliðindeki bilgidir, dizidir. formdaki adý sdscheck[]'dir
	var $sdscheck;

	// sdsduzelt: formdaki gönder butonu. formdaki adi: sdsduzelt
	var $sdsduzelt;

	// sdssil: formdaki sil butonu. formdaki adi: sdssil
	var $sdssil;

	// DUZELT BOLUMU - sdsduzeltyazi: formdaki degistirilecek yazilari icerir iki boyutlu dizidir. formdaki adý: sdsduzeltyazi[][] seklinde
	var $sdsduzeltyazi;
	...
	// TEK DUZELT BOLUMU - sdsduzeltyazi: formdaki degistirilecek yazilari icerir iki boyutlu dizidir. formdaki adý: sdsduzeltyazi[][] seklinde
	var $duzeltyazi;
	...
	*/
	function _duzeltiyorum(){
		...
		if($k==$i){
			...
			$cevap = "Error: $k rows updated but error on ".($i-$k)." rows .<br>"."Mysql Hata Çiktisi:<br>\"$hata\"<br>";
			...
			$hata = $this->vty->DiziyiAc($hata,"<br>");
			$cevap = $this->vty->dug->uy['SatirlarDuzeltHata']."<br>"."Mysql Hata Çiktisi:<br>\"$hata\"<br>";
			echo "<font color=\"red\">$cevap</font>\n<br>\n".
                "<div style='margin:5;'></div>".
                   "<a href=\"javascript:history.back(-1)\">&lt;&lt; ".$this->vty->dug->dil['Geri']."</a> | <a href=\"".$this->vty->urlyap($this->vty->linkler)."\" >".$this->vty->dug->dil['Tamam']."</a>\n";
		}
