<div class="panel panel-default main-container">
    ...
    <div class="panel-footer">
        <div class="btn-group btn-group-justified" role="group">
            <a data-target="#info-modal" data-toggle="modal" class="btn btn-default btn-sm">Info</a>
            <a data-target="#contact-modal" data-toggle="modal" class="btn btn-default btn-sm">Contact</a>
            <a href="{{ url('profile/edit') }}" class="btn btn-default btn-sm">Edit</a>
        </div>
    </div>
    ...
    <div class="modal fade" id="info-modal" tabindex="-1" role="dialog">
        <div class="modal-dialog deactive-modal-dialog" role="document">
            <div class="modal-content main-container">
                <div class="modal-body">
                    <ul class="list-group">
                        <li class="list-group-item list-item"><i class="fa fa-clock-o list-item-icon"></i>Since <time class="timeago" atetime="{{ $user['date'] }}"></time></li>
